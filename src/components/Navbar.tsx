...
const Navbar: React.FC<NavbarProps> = ({ darkMode, onThemeChange }) => {
  ...
  return (
    <div className={`flex justify-between items-center w-full px-[3%] lg:px-[2%] xl:px-[2%] 2xl:px-[13%] py-[15px] sm:pt-[20px] md:pt-[60px] lg:pt-[80px] xl:pt-[90px] ${darkMode ? 'bg-black-200' : 'bg-white'}`}>
